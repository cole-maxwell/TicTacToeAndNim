...
public class PlayNim4 {
	...
	public void doComputerMove() {
		Best compMove = g.chooseMove(Nim5.COMPUTER, 0);  // level 0 call
		System.out.println("Computer plays ROW = " + compMove.row + " STARS = " + compMove.column);
		g.playMove(Nim5.COMPUTER, compMove.row, compMove.column);
	}
	...
	public void doHumanMove() {
		...
		do {
			...
			legal = g.playMove(Nim5.HUMAN, row, stars);
			if (!legal)
